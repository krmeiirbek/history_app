        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              SizedBox(
                ...
                child: Column(
                  children: [
                    ...
                    TextButton(onPressed: () {}, child: const Text('Профиль суретін өзгерту')),
                  ],
                ),
              ),
              ...
              const SizedBox(height: TSizes.spaceBtwItems),
              TProfileMenu(onPressed: () => Get.to(() => const ChangeName()), title: 'Аты', value: controller.userModel.fullName),
              TProfileMenu(onPressed: () {}, title: 'Тегі', value: controller.userModel.userName),
              const SizedBox(height: TSizes.spaceBtwItems),
              const Divider(),
              const SizedBox(height: TSizes.spaceBtwItems),
              const TSectionHeading(title: 'Жеке ақпарат'),
              const SizedBox(height: TSizes.spaceBtwItems),
              TProfileMenu(onPressed: () {}, title: 'Қолданушы ID', value: controller.userModel.id, icon: Iconsax.copy),
              TProfileMenu(onPressed: () {}, title: 'E-mail', value: controller.userModel.email),
              TProfileMenu(onPressed: () {}, title: 'Телефон нөмірі', value: controller.userModel.phoneNumber),
              ...
              Center(
                child: TextButton(
                    onPressed: () {}, child: const Text('Есептік жазбаны жою', style: TextStyle(color: Colors.red))),
              )
            ],
          ),
        ),
