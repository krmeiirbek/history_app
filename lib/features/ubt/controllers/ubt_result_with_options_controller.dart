...
class UBTResultWithOptionsController extends GetxController {
  ...
  void onInit() {
    super.onInit();
    loading.value = true;
    questions = Get.arguments["questions"] as List<UBTQuestionModel>;
    selectedOptions = Get.arguments["selectedOptions"] as List<List<UBTOptionModel>>;
    loading.value = false;
  }
